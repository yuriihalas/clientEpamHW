...
public class ConstCopterREST {
    ...
    public static final String GET_ALL_COPTERS_URL = DEFAULT_URL;
    public static final String GET_FIND_COPTER_BY_ID = DEFAULT_URL + "%d";
    ...
    public static final String MOVE_TO_POSITION_WITH_DEGREE_URL = DEFAULT_URL + "%d/%s";
