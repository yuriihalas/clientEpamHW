...
public class DataHoldPosition extends JsonParser {
    ...
    private static JSONArray getCorrectArray() {
        return (JSONArray) getMoveDownData().get("correct");
    }

    private static JSONArray getUnCorrectArray() {
        return (JSONArray) getMoveDownData().get("unCorrect");
    }

    private static JSONObject getMoveDownData() {
        return (JSONObject) jsonObject.get("holdPosition");
    }
